...
<!--- :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->	
	<cffunction name="attemptLogin" access="public" output="false" returntype="boolean">	
		<cfargument name="username" type="string" required="true" />
		<cfargument name="password" type="string" required="true" />
		
		<cfset var isAuthor = checkCredentials(arguments.username, arguments.password) />
		<cfset var author = "" />
		<cfif isAuthor>
			<cfset author = getAuthorByUsername(arguments.username, true) />
