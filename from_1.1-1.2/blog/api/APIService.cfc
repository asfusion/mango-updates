...
<!--- ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->
	<cffunction name="dataUpdated" access="remote" output="false" returntype="void">
		<cfargument name="username" type="String" required="true" />
		<cfargument name="password" type="String" required="true" />
		<cfargument name="event" type="String" required="false" default="configChanged" />

			<cfif variables.administrator.checkCredentials(arguments.username,arguments.password,true) 
				...
				<cfswitch expression="#listgetat(arguments.event,1,'|')#">
					<cfcase value="configChanged,blogUpdated">
						<cfset  variables.blogManager.reloadConfig() />
					</cfcase>
					<cfcase value="pageUpdated,pageAdded,pageDeleted">
						<cfset variables.blogManager.getPagesManager().updateEvent(arguments.event) />
					</cfcase>
					<cfcase value="postUpdated,postAdded,postDeleted">
						<cfset variables.blogManager.getPostsManager().updateEvent(arguments.event) />
					</cfcase>
				</cfswitch>
			</cfif>
	</cffunction>			
