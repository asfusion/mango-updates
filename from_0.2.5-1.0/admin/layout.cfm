...
<script language="javascript" type="text/javascript" src="assets/editors/tinymce_3/tiny_mce_popup.js"></script>
<script language="javascript" type="text/javascript">
	tinyMCE.init({
		mode : "specific_textareas",
		editor_selector : "htmlEditor",
		theme : "advanced",
		plugins : "table,save,flash,contextmenu,paste,noneditable,asffileexplorer",
...
<cfoutput>content_css : "#blog.getbasePath()#skins/#request.blogManager.getBlog().getSkin()#/#request.currentSkin.adminEditorCss#",</cfoutput></cfif>
