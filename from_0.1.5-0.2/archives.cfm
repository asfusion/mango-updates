...
<cfelseif structkeyexists(request.externalData,"category")>
...
<!--- <cfelseif structkeyexists(request.externalData,"search")>
<!--- try to see if maybe the friednly urls are not used and query string is used instead--->
...
<cfcontent reset="true" /><cfinclude template="#blog.getbasePath()#skins/#blog.getSkin()#/archives.cfm">