...
<mango:Posts count="5">
	...
	<!-- Page Navigation -->
	<div class="pagenav">
		<div class="alignleft"><mango:ArchiveProperty ifHasNextPage><a class="previous" href="<mango:ArchiveProperty link pageDifference="1" />">&lt; Previous Entries</a></mango:ArchiveProperty> </div>
		<div class="alignright"><mango:ArchiveProperty ifHasPreviousPage><a class="next" href="<mango:ArchiveProperty link pageDifference="-1" />">Next Entries &gt;</a></mango:ArchiveProperty></div>
	</div>
		</mango:Archive>			
</div><!-- End of #content -->
