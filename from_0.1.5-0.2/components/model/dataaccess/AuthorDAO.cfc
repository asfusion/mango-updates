...
<cfargument name="id" required="true" type="string" hint="Primary key"/>
	...
	<cfset var qgetauthor = ""/>
		...
		<cfquery name="qgetauthor"  datasource="#variables.dsn#">
...
<cffunction name="create" output="false" hint="Inserts a new record" access="public" returntype="struct">
	...
	<cftry>
		<cfquery name="qinsertauthor"  datasource="#variables.dsn#">
			...
			(id, username,password,name,email,description, shortdescription, picture, alias)
			VALUES (
			...
			<cfqueryparam value="#arguments.author.getdescription()#" cfsqltype="CF_SQL_LONGVARCHAR" />,
			<cfqueryparam value="#arguments.author.getshortdescription()#" cfsqltype="CF_SQL_LONGVARCHAR" />,
		  ...
		  <cfloop index="i" from="1" to="#arraylen(blogs)#">
			  <cfquery name="qinsertauthor"  datasource="#variables.dsn#">
				...
				VALUES (
				<cfqueryparam value="#id#" cfsqltype="CF_SQL_VARCHAR" maxlength="35"/>,
				<cfqueryparam value="#blogs[i].getid()#" cfsqltype="CF_SQL_VARCHAR">)
			  </cfquery>
			</cfloop>
...
<cffunction name="update" output="false" hint="Updates a record" access="public" returntype="struct">
	...
	<cftry>
		<cfquery name="qupdateauthor"  datasource="#variables.dsn#">
		...
		description = <cfqueryparam value="#arguments.author.getdescription()#" cfsqltype="CF_SQL_LONGVARCHAR" />,
		shortdescription = <cfqueryparam value="#arguments.author.getshortdescription()#" cfsqltype="CF_SQL_LONGVARCHAR" />,
...
<cfargument name="id" required="true" type="numeric" hint="Primary key"/>
	...
	<cftry>
		<!--- remove old blogs from author--->
		<cfquery name="qdeleteauthor"  datasource="#variables.dsn#">
			DELETE FROM #variables.prefix#author_blog
