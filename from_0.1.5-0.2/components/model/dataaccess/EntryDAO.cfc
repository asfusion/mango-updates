...
<!---	<cftry> --->
		<cfquery name="qinsertentry"  datasource="#variables.dsn#">
...
<cffunction name="update" output="false" hint="Updates a record" access="public" returntype="struct">
	...
	<cftry>
		<cfquery name="qupdateentry"  datasource="#variables.dsn#">
...
<cfargument name="id" required="true" type="string" hint="Primary key"/>
	...
	<cftry>
		<cfquery name="qdeleteentry"  datasource="#variables.dsn#">
