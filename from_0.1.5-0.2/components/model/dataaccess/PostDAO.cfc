...
<!--- :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->
	<cffunction name="read" output="false" access="public" returntype="any">
		<cfargument name="post" required="true" type="any" hint="Post object to populate"/>
		
		<cfset var qRead="">
		<cfset arguments.post = super.read(arguments.post) />

		<cfquery name="qRead" datasource="mango">
			select 	id, posted_on
			from #variables.prefix#post
			where id = <cfqueryparam value="#arguments.post.getId()#" cfsqltype="CF_SQL_VARCHAR" maxlength="35"/>
		</cfquery>

		<cfscript>
			arguments.post.setposted_on(qRead.posted_on);
...
<cffunction name="create" output="false" hint="Inserts a new record" access="public" returntype="struct">
	...
	<cfscript>
		...
		if (NOT len(replace(tempName, "-", "", "ALL"))){
			tempName = randrange(1000,9999);
		}
	...
	<cfif returnObj["status"]>
		<cftry>
			<cfquery name="qinsertpost"  datasource="#variables.dsn#">
...
<cffunction name="update" output="false" hint="Updates a record" access="public" returntype="struct">
	...
	<cfif returnObj["status"]>
	<cftry>
		<cfquery name="qupdatepost"  datasource="#variables.dsn#">
...
<cfargument name="id" required="true" type="string" hint="Primary key"/>
	...
	<cftry>
		<cfquery name="qdeletepost"  datasource="#variables.dsn#">
...
<!---	<cftry> --->
		<cfquery name="qSetCategories"  datasource="#variables.dsn#">
