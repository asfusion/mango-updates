...
<!--- :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->	
	<cffunction name="setup" hint="This is run when a plugin is activated" access="public" output="false" returntype="any">
		...
		<cfset variables.preferencesManager.put(path,"accountNumber","YOUR_ACCOUNT_NUMBER") />
		<cfreturn />
	</cffunction>
...
<!--- :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->	
	<cffunction name="processEvent" hint="Synchronous event handling" access="public" output="false" returntype="any">
		<cfargument name="event" type="any" required="true" />
			...
			<cfif arguments.event.getName() EQ "beforeHtmlBodyEnd">
...
pageTracker._trackPageview();
			...
			<!--- admin event --->
			<cfelseif arguments.event.getName() EQ "showGoogleAnalyticsSettings">
					...
					<cftry>
						<cfif structkeyexists(session,"author")>
							<cfset variables.manager.getAdministrator().pluginUpdated(
									"googleAnalytics", variables.id, session.author) />
						</cfif>
