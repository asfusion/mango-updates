...
<!--- ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->	
	<cffunction name="init" output="false" returntype="any" access="public">
		...
		<cfargument name="page" type="any" required="false" default="#CreateObject('component', 'ObjectFactory').createPage()#" />
...
<!--- ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->	
	<cffunction name="setInstance" output="false" returntype="any" access="package">
		<cfargument name="myObject" type="any" required="true" />
			...
			<cfset variables.myObjectClone = variables.myObject.clone(CreateObject("component", "ObjectFactory").createPage()) />
