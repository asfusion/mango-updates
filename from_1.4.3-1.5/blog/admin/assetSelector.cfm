...
<cfelse>
	<cfset fileUrl = blog.getBasePath() & assetsSettings.path />
</cfif>
...
<cfoutput>
	...
	<param name="flashvars" value="path=#blog.getbasePath()#admin/com/asfusion/&initialPath=#url.initialPath#" />
	<!--[if !IE]>-->
	<object type="application/x-shockwave-flash" data="assets/swfs/AssetSelector.swf" width="100%" height="98%">
		<param name="bgcolor" value="##FFFFFF" />
		<param name="flashvars" value="path=#blog.getbasePath()#admin/com/asfusion/&initialPath=#url.initialPath#" />
	<!--<![endif]-->
	<div>
