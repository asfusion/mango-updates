...
<!--- :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->	
	<cffunction name="processEvent" hint="Synchronous event handling" access="public" output="false" returntype="any">
		...
		<cfif eventName EQ "beforeAdminPostContentEnd" OR eventName EQ "beforeAdminPageContentEnd">
		...
		<cfelseif eventName EQ "versioner-showRevision">
		...
		<!--- ____________________________________________________ --->
		<cfelseif eventName EQ "versioner-restoreRevision">
			<cfset local.revision = getRevision(data.externaldata.revision) />
