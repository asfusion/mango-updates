<cfcomponent displayname="Application">
	<cfscript>
		this.name = "mango_#right(hash(GetDirectoryFromPath(GetCurrentTemplatePath())),50)#_v1_4";
		...
		if (server.coldfusion.productname is "ColdFusion Server" and 
				listFirst(server.coldfusion.productversion) gte 8) {
			//this is apparently cf8
