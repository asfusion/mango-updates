	...
	<cfoutput>
		<cfset local.utils = createObject("component","helpers.Utils") />
				...
				<cfcatch type="any">
					...
					<a href="http://mangoblog.googlecode.com/files/MangoBlog_update_from_1.4-1.4.1.zip">http://mangoblog.googlecode.com/files/MangoBlog_update_from_1.4-1.4.1.zip</a>
