...
<form method="post" action="#cgi.script_name#">
	...
	<p>
		...
		<span class="field"><textarea rows="10" cols="60" id="searchBoxCode" name="searchBoxCode">#variables.searchBoxCode#</textarea></span>
	</p>
	
	<p>
		<label for="searchResultsCode">Search Results Code</label>
		<span class="field"><textarea rows="10" cols="60" id="searchResultsCode" name="searchResultsCode">#variables.searchResultsCode#</textarea></span>
	</p>
