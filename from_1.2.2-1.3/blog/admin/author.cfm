		...
		<cfoutput><form method="post" action="#cgi.SCRIPT_NAME#" id="authorForm">
			...
			<fieldset>
				...
				<p>
					...
					<span class="field"><input type="text" id="name" name="name" value="#name#" size="30" class="required"/></span>
				</p>
				
				<p>
					<label for="username">Username</label>
					<span class="hint">A unique username for authentication purposes</span>
					<span class="field"><input type="text" id="username" name="username" value="#username#" size="20" class="validate-alphanum required"/></span>
				</p>
				
				<p>
					<label for="password">Password</label>
					<span class="field"><input type="password" id="password" name="password" value="#password#" size="30" class="required"/></span>
				</p>
				...
				<p>
					...
					<span class="field"><textarea cols="40" rows="4" id="shortdescription" name="shortdescription">#shortdescription#</textarea></span>
				</p>
				
				<p>
					<label for="authorDescription">Description</label>
					<span class="hint">Text to show in author's page</span>
					<span class="field"><textarea cols="60" rows="10" id="authorDescription" name="description" class="htmlEditor"  style="width: 100%">#description#</textarea></span>
				</p>
			</fieldset>
