...
<form method="post" action="#cgi.SCRIPT_NAME#" name="settingsForm" id="settingsForm">
	...
	<fieldset id="settingsForm_general">
		...
		<p>
			...
			<span class="field"><input type="text" id="title" name="title" value="#title#" size="30" class="required"/></span>
		</p>
		
		<p>
			<label for="tagline">Tagline</label>
			<span class="hint">A catchy tagline. Whether or not it is shown in your blog depends on the current template</span>
			<span class="field"><input type="text" id="tagline" name="tagline" value="#tagline#" size="40" class=""/></span>
		</p>
		
		<p>
			<label for="description">Description</label>
			<span class="hint">A small description of what your blog is about</span>
			<span class="field"><textarea cols="60" rows="5" id="description" name="description" class="">#description#</textarea></span>
		</p>
		...
		<p>
			...
			<span class="field"><input type="text" id="address" name="address" value="#address#" size="40" class="required url2"/></span>
		</p>
	</fieldset>
