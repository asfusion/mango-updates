	...
	<cfif found>
		<form method="post" action="comment_edit.cfm">
			<p>
				...
				<span class="field"><input type="text" id="creatorName" name="creatorName" value="#name#" size="40" class="required"/></span>
			</p>
			
			<p>
				<label for="creatorEmail">Email</label>
				<span class="field"><input type="text" id="creatorEmail" name="creatorEmail" value="#email#" size="40" class="required email"/></span>
			</p>
			
			<p>
				<label for="creatorUrl">Website</label>
				<span class="field"><input type="text" id="creatorUrl" name="creatorUrl" value="#website#" size="40" class="url"/></span>
			</p>
			
			<p>
				<label for="content">Comment</label>
				<span class="field">
					<textarea cols="80" rows="10" id="content" name="content" class="required">#content#</textarea></span>
			</p>
