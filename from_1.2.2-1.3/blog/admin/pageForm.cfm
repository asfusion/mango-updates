		...
		<cfif listfind(showFields,'parent')>
			<p>
				...
				<span class="field"><select name="parentPage" id="parentPage">
					...
					<option value="#pages[i].getId()#" <cfif parent EQ pages[i].getId()>selected="selected"</cfif>>#pages[i].getTitle()#</option></cfloop>
				</select></span>
			</p>
		<cfelse>
		...
		<cfif arraylen(templates) AND listfind(showFields,'template')>
			<p>
				...
				<span class="field"><select id="template" name="template">
					...
					<option value="#templates[i].file#" <cfif templates[i].file EQ template>selected="selected"</cfif>>#templates[i].name#</option></cfloop>
				</select></span>
			</p>
		<cfelse>
