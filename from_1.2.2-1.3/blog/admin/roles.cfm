				...
				<fieldset id="roleFieldset">
					...
					<div class="column1">
						...
						<ol>
							...
							<li>
								...
								<label for="permissions_#permissions[i].id#" id="permissions_#permissions[i].id#-L" class="postField">#permissions[i].name#</label>
								<span class="hint">#permissions[i].description#</span>
							</li>
							</cfloop>
						</ol>
					</div><!--- /column1 --->
					...
					<div class="column2">
						...
						<cfset options =
								...
								"users_roles,Users Submenu: Roles," &
								"cache,Cache," &
								"settings,Settings" />
						<ol>
