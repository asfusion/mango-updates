...
<!--- ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->
		...
		<cfargument name="data" required="true" type="array" />
			...
			<cfloop index="i" from="1" to="#arraylen(posts)#">
				...
				//@todo check this
										...
										result[1][j].permaLink ="#request.appMapping#permalinks/#left(date,4)#/#mid(date,5,2)#/#right(date,2)#/#replace(arrayShow[k].menuitem,' ','-','ALL')#";
	...
	<!--- @TODO verify that this works (can't find any client that uses it') --->
	<!--- ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: --->
	<!--- 
postId - (string): ID
...
The struct must contain at least three elements, name, type and bits. --->
	<cffunction name="newMediaObject" access="remote" output="false" returntype="struct">
		<cfargument name="data" required="true" type="array" />
