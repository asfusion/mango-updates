...
<cffunction name="getAll" output="false" hint="Gets all the records" access="public" returntype="query">
	...
	<cfquery name="q_categoryGetAll" datasource="#variables.dsn#"  username="#variables.username#" password="#variables.password#" cachedwithin="#CreateTimeSpan(0, 0, variables.cacheMinutes, 0)#">
		SELECT	category.*
		FROM	#variables.prefix#category as category
